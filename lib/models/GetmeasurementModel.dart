...
GetmeasurementModel getordersFromJson(String str) => GetmeasurementModel.fromJson(json.decode(str));

String getordersToJson(GetmeasurementModel data) => json.encode(data.toJson());

class GetmeasurementModel {
  GetmeasurementModel({
    this.status,
    this.message,
    this.data,
  ...
  factory GetmeasurementModel.fromJson(Map<String, dynamic> json) => GetmeasurementModel(
    status: json["status"],
